...
export default function Home() {
    const [logoSrc, setLogoSrc] = useState("/demo_logo.png");
    ...
    useEffect(() => {
        ...
        const expandButton = document.querySelector(`.${styles.rolloutbutton}`);
        ...
        const checkContrast = () => {
            const primaryButtons = document.querySelectorAll(`.${styles['primary-button']}`);
            const secondaryButtons = document.querySelectorAll(`.${styles['secondary-button']}`);
            const partTwo = document.querySelectorAll(`.${styles.part2}`);
            const primbuttnColorClass = document.querySelector(`.${styles.primbuttn}`);
            const secbuttnColorClass = document.querySelector(`.${styles.secbuttn}`);
            const accentColorClass = document.querySelector(`.${styles.accent}`);
            ...
            primaryButtons.forEach(primaryButton => {
                ...
                if (primaryBrightness < secondaryBrightness) {
                    primaryButton.style.color = contrastRatio < 4.5 ? 'var(--secondary)' : 'var(--primary)';
                    if (primbuttnColorClass) primbuttnColorClass.style.color = contrastRatio < 4.5 ? 'var(--secondary)' : 'var(--primary)';
                } else {
                    primaryButton.style.color = contrastRatio < 4.5 ? 'var(--secondary)' : 'var(--primary)';
                    if (primbuttnColorClass) primbuttnColorClass.style.color = contrastRatio < 4.5 ? 'var(--secondary)' : 'var(--primary)';
                }
            ...
            secondaryButtons.forEach(secondaryButton => {
                ...
                if (primaryBrightness < secondaryBrightness) {
                    secondaryButton.style.color = contrastRatio < 4.5 ? 'var(--secondary)' : 'var(--primary)';
                    if (secbuttnColorClass) secbuttnColorClass.style.color = contrastRatio < 4.5 ? 'var(--secondary)' : 'var(--primary)';
                } else {
                    secondaryButton.style.color = contrastRatio < 4.5 ? 'var(--secondary)' : 'var(--primary)';
                    if (secbuttnColorClass) secbuttnColorClass.style.color = contrastRatio < 4.5 ? 'var(--secondary)' : 'var(--primary)';
                }
            ...
            partTwo.forEach(part => {
                ...
                if (primaryBrightness < secondaryBrightness) {
                    part.style.color = contrastRatio < 4.5 ? 'var(--secondary)' : 'var(--primary)';
                    if (accentColorClass) accentColorClass.style.color = contrastRatio < 4.5 ? 'var(--secondary)' : 'var(--primary)';
                } else {
                    part.style.color = contrastRatio < 4.5 ? 'var(--secondary)' : 'var(--primary)';
                    if (accentColorClass) accentColorClass.style.color = contrastRatio < 4.5 ? 'var(--secondary)' : 'var(--primary)';
                }
...
Thanks for trying out SMLNEXGEN's Demo!`;
                ...
                // Capture a specific div (e.g., #home) with toolbar hidden and gradient text handled
                const specificDiv = document.getElementById('home');
                const screenshotCanvas = await html2canvas(specificDiv, {
                    useCORS: true,
                    backgroundColor: null,
                    onclone: (clonedDoc) => {
                        // Temporarily hide the toolbar
                        const toolbar = clonedDoc.querySelector(`.${styles.toolbar}`);
                        if (toolbar) {
                            toolbar.style.display = 'none';
                        }

                        // Handle gradient text by forcing solid color for capture
                        const colorEffectElements = clonedDoc.querySelectorAll(`.${styles['color-effect']}`);
                        colorEffectElements.forEach(element => {
                            // Remove gradient and apply a solid color (e.g., primary or secondary)
                            element.style.background = 'none'; // Remove gradient
                            element.style.webkitBackgroundClip = 'initial'; // Reset background clip
                            element.style.webkitTextFillColor = 'var(--primary)'; // Use primary color as fallback
                        });
                    },
                });
            ...
            <div className={styles.container}>
                <nav className={styles.nav}>
                    <div className={styles.logo}>
                        ...
                        />
                        <Link href="#">
                            <h2 contentEditable spellCheck={false} className={styles.sitename}>Your website</h2>
                        </Link>
                    </div>
                    <div className={styles.menu}>
                        <Link href="#why" className={styles['menu-item']}>About</Link>
                        <Link href="#how" className={styles['menu-item']}>Blog</Link>
                        <Link href="#end" className={styles['menu-item']}>Contact</Link>
                        <Link href="#sub" className={styles['primary-button']}>Subscribe</Link>
                    </div>
                </nav>
                ...
                <div className={styles.hero}>
                    <div className={styles['hero-text']}>
                        <h1 contentEditable spellCheck={false}>
                            Try editing <span className={styles['color-effect']}>text</span>
                        </h1>
                        <p contentEditable spellCheck={false} className={styles.subtitle}>Lorem ipsum dolor sit amet,<br />consectetur adipiscing elit.</p>
                        <div className={styles['hero-cta']}>
                            <Link href="#toolbar" className={styles['primary-button']} onClick={highlightToolbar}>Get Started</Link>
                            <Link href="#how" className={styles['secondary-button']}>Know more</Link>
                        </div>
                    </div>
                    <div className={styles['hero-img']}>
                        <svg xmlns="http://www.w3.org/2000/svg" width="652" height="644" viewBox="0 0 652 644" fill="none" className={styles.mondrian}>
                ...
                <main className={styles.main}>
                    ...
                    <div className={styles.part2} id="how">
                        ...
                        <div className={styles['part2-right']}>
                            <p className={`${styles.one} ${styles.step}`}>Lorem ipsum dolor sit amet, consectetur adipiscing elit. <br /><br />Lorem ipsum dolor sit amet, consectetur adipiscing elit.</p>
                            <p className={`${styles.two} ${styles.step}`}>Lorem ipsum dolor sit amet, consectetur adipiscing elit. <br /><br />Lorem ipsum dolor sit amet, consectetur adipiscing elit.</p>
                            <p className={`${styles.three} ${styles.step}`}>Lorem ipsum dolor sit amet, consectetur adipiscing elit.<br /> <br />Lorem ipsum dolor sit amet, consectetur adipiscing elit.</p>
                            <p className={`${styles.four} ${styles.step}`}>Lorem ipsum dolor sit amet, consectetur adipiscing elit. <br /><br />Lorem ipsum dolor sit amet, consectetur adipiscing elit.</p>
                        </div>
                    </div>
                    ...
                    <div className={styles.part5} id="end">
                        <h1>Your <span className={styles['color-effect']}>Journey</span> Shouldn’t End Here.</h1>
                        <p className={styles.subtitle}>Follow us and stay tuned on more...</p>
                        <Link href="#" className={styles['primary-button']}>Stay Tuned</Link>
                    </div>
                    ...
                    <div className={styles.footer} id="footer">
                        <div className={styles['footer-cols']}>
                            ...
                            <div className={styles['footer-col']}>
                                <Link href="#home" className={`${styles['menu-item']} ${styles.reversed}`}>Home</Link>
                                <Link href="#why" className={`${styles['menu-item']} ${styles.reversed}`}>About</Link>
                                <Link href="#how" className={`${styles['menu-item']} ${styles.reversed}`}>Blog</Link>
                                <Link href="#end" className={`${styles['menu-item']} ${styles.reversed}`}>Contact</Link>
                            </div>
                            <div className={styles['footer-col']}>
                                <Link href="#x" className={`${styles['menu-item']} ${styles.reversed}`}>X</Link>
                                <Link href="#facebook" className={`${styles['menu-item']} ${styles.reversed}`}>Facebook</Link>
                                <Link href="#youtube" className={`${styles['menu-item']} ${styles.reversed}`}>YouTube</Link>
                                <Link href="#insta" className={`${styles['menu-item']} ${styles.reversed}`}>Instagram</Link>
                            </div>
                        </div>
                    ...
                    <div className={styles.toolbar} id="toolbar">
                        <div className={`${styles.option} ${styles.prim} ${styles.rollout}`}>
                            <input type="color" id="prim" name="prim" className={styles.colorpicker} defaultValue="#000000" />
                            <label htmlFor="prim">Text</label>
                        </div>
                        <div className={`${styles.option} ${styles.sec} ${styles.rollout}`}>
                            <input type="color" id="sec" name="sec" className={styles.colorpicker} defaultValue="#ffffff" />
                            <label htmlFor="sec">Background</label>
                        </div>
                        <div className={`${styles.option} ${styles.primbuttn} ${styles.rollout}`}>
                            <input type="color" id="primbuttn" name="primbuttn" className={styles.colorpicker} defaultValue="#4685FF" />
                            <label htmlFor="primbuttn">Primary Button</label>
                        </div>
                        <div className={`${styles.option} ${styles.secbuttn} ${styles.rollout}`}>
                            <input type="color" id="secbuttn" name="secbuttn" className={styles.colorpicker} defaultValue="#F2F2F2" />
                            <label htmlFor="secbuttn">Secondary Button</label>
                        </div>
                        <div className={`${styles.option} ${styles.accent} ${styles.rollout}`}>
                            <input type="color" id="accent" name="accent" className={styles.colorpicker} defaultValue="#FFB084" />
