...
const Preloader = () => {
  ...
  const systemLogs = [
    { text: 'Analyzing dependencies...', delay: 100, className: styles.command },
    { text: 'Found 24 dependencies, resolving...', delay: 50, className: styles.info },
    { text: 'Loading modules...', delay: 75, className: styles.command },
    { text: 'Core modules loaded successfully', delay: 62, className: styles.success },
    { text: 'Initializing components...', delay: 75, className: styles.command },
    { text: '> UI components initialized', delay: 50, className: styles.info },
    { text: '> Data services initialized', delay: 50, className: styles.info },
    { text: 'Compiling...', delay: 100, className: styles.command },
    { text: 'Transpiling TypeScript...', delay: 75, className: styles.info },
    { text: 'Processing SASS...', delay: 62, className: styles.info },
    { text: 'Minifying assets...', delay: 75, className: styles.info },
    { text: 'Compilation successful', delay: 75, className: styles.success },
    { text: 'Optimizing bundle...', delay: 75, className: styles.command },
    { text: 'Tree shaking unused code...', delay: 62, className: styles.info },
    { text: 'Compressing assets...', delay: 62, className: styles.info },
    { text: 'Build successful', delay: 75, className: styles.success },
    { text: 'Bundle size: 247.3KB (82.4KB gzipped)', delay: 75, className: styles.info },
