...
import { MdHome, MdInfo, MdBuild, MdEmail, MdWork, MdEngineering, MdMenu, MdClose } from "react-icons/md";
...
export default function Navbar() {
  ...
  return (
    ...
    >
      ...
      {isMobileMenuOpen && (
        <div className="xl:hidden absolute top-full left-0 w-full bg-gray-800 z-10">
